    ...
    <div className="max-w-screen overflow-x-hidden px-4 py-6">
      ...
      <header className="py-10 mb-6">
        <div className="max-w-8xl mx-auto flex items-center justify-between">
          ...
          <button className="px-4 py-2 bg-gray-500 rounded-lg text-white hover:bg-gray-700">
            Thêm nhóm quyền +
          </button>
        </div>
      </header>
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <div className="flex flex-col mb-4 mr-8 md:mb-0">
            ...
            <input
              id="searchName"
              type="text"
              placeholder="Tìm kiếm theo sản phẩm, nhà cung cấp"
              className="text-xl w-[22em] p-2 border border-gray-300 rounded-md box-border"
            />
          </div>
                ...
                <td>
                  <span
                    className={`border border-gray-300 rounded-lg px-2 py-1 ${
                      role.status === 'hd' ? 'text-green-700' : 'text-red-500'
                    }`}
                  >
                    {role.status === 'hd' ? 'Hoạt động' : 'Ẩn'}
                  </span>
                </td>
                <td>
