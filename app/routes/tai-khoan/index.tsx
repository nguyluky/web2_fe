...
function ThongTin({profile}: {profile: getProfileResponse['data']}) {
    ...
    const [previewImage, setPreviewImage] = useState<string | null>(profileData.avatar ? `${profileService.baseUrl.replace('api', 'storage')}/${profile.avatar}` : null);
                ...
                <div className="flex gap-5 items-center">
                    <div className="avatar cursor-pointer relative group" onClick={() => setIsModalOpen(true)}>
                        <div className="w-24 rounded-full overflow-hidden">
                            <img src={profileData.avatar ? `${profileService.baseUrl.replace('api', 'storage')}/${profile.avatar}` : "https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.webp"} alt="Avatar" />
